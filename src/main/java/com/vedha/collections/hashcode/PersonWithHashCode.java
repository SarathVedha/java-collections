...
public class PersonWithHashCode {
    ...
    public static void main(String[] args) {
        ...
        PersonWithHashCode person3 = new PersonWithHashCode("John", 30);
        ...
        System.out.println("person1 == person2: " + (person1.hashCode() == person2.hashCode())); // true - because hashcode method is overridden
        System.out.println("person1.equals(person2): " + person1.equals(person2)); // false - because equals method is not overridden
        System.out.println("person1==person3: " + (person1.hashCode() == person3.hashCode())); // false
